...
RUN sudo apt-get update && sudo apt-get install -y --no-install-recommends libnvinfer5=5.1.5-1+cuda10.0 libnvinfer-dev=5.1.5-1+cuda10.0

# Install wget (to make life easier below) and editors (to allow people to edit
# the files inside the container)
RUN sudo apt-get update && \
    sudo apt-get install -y wget vim emacs nano git sudo
...
RUN sudo apt-get update && \
    sudo apt-get install -y protobuf-compiler python-pil python-lxml python-tk python3-dev clang python3-catkin-pkg-modules ros-melodic-pcl-ros ros-melodic-tf2-geometry-msgs ros-melodic-ros-type-introspection ros-melodic-geometry
...
RUN sudo apt-get install -y python3-rospkg python3-opencv
...
RUN sudo apt-get update && sudo apt-get install -y librealsense2-dkms librealsense2-utils librealsense2-dev librealsense2-dbg ros-melodic-diagnostic-updater ros-melodic-image-transport ros-melodic-tf2-geometry-msgs ros-melodic-nodelet ros-melodic-dynamic-reconfigure ros-melodic-rospy ros-melodic-nav-msgs ros-melodic-camera-info-manager ros-melodic-perception-pcl python3-setuptools python3-pip python3-yaml python3-dev python3-numpy
...
RUN sudo apt-get install -y ros-melodic-camera-info-manager ros-melodic-visualization-msgs ros-melodic-cv-bridge ros-melodic-image-geometry ros-melodic-serial ros-melodic-rqt ros-melodic-angles libserial-dev ros-melodic-rosbash ros-melodic-geometry ros-melodic-rosfmt libncurses-dev libncurses5-dev libncurses5-dev
