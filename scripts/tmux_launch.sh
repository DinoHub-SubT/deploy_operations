...
if chk_flag -st $@ ; then
  ...
  ssh -t ${args[0]} "ROBOT=${args[1]} tmuxp load ~/deploy_ws/operations/TODO/tmux/${args[2]}.start.yaml"
...
# stop the tmux session
  ...
  ssh -t ${args[0]} "ROBOT=${args[1]} tmuxp load ~/deploy_ws/operations/TODO/tmux/${args[2]}.stop.yaml"
