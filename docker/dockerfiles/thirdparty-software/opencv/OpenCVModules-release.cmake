...
set_target_properties(opencv_core PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libopencv_core.so.3.3.1"
  IMPORTED_SONAME_RELEASE "libopencv_core.so.3.3"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_core )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_core "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libopencv_core.so.3.3.1" )

# Import target "opencv_flann" for configuration "Release"
set_property(TARGET opencv_flann APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
set_target_properties(opencv_flann PROPERTIES
  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE "opencv_core"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libopencv_flann.so.3.3.1"
  IMPORTED_SONAME_RELEASE "libopencv_flann.so.3.3"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_flann )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_flann "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libopencv_flann.so.3.3.1" )
...
#  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE "opencv_core"
#  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libopencv_hdf.so.3.2.0"
#  IMPORTED_SONAME_RELEASE "libopencv_hdf.so.3.2"
#  )

#list(APPEND _IMPORT_CHECK_TARGETS opencv_hdf )
#list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_hdf "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libopencv_hdf.so.3.2.0" )

# Import target "opencv_imgproc" for configuration "Release"
set_property(TARGET opencv_imgproc APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
set_target_properties(opencv_imgproc PROPERTIES
  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE "opencv_core"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libopencv_imgproc.so.3.3.1"
  IMPORTED_SONAME_RELEASE "libopencv_imgproc.so.3.3"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_imgproc )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_imgproc "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libopencv_imgproc.so.3.3.1" )

# Import target "opencv_ml" for configuration "Release"
set_property(TARGET opencv_ml APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
set_target_properties(opencv_ml PROPERTIES
  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE "opencv_core"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libopencv_ml.so.3.3.1"
  IMPORTED_SONAME_RELEASE "libopencv_ml.so.3.3"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_ml )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_ml "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libopencv_ml.so.3.3.1" )

# Import target "opencv_photo" for configuration "Release"
set_property(TARGET opencv_photo APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
set_target_properties(opencv_photo PROPERTIES
  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE "opencv_core;opencv_imgproc"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libopencv_photo.so.3.3.1"
  IMPORTED_SONAME_RELEASE "libopencv_photo.so.3.3"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_photo )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_photo "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libopencv_photo.so.3.3.1" )
...
#  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE "opencv_core;opencv_imgproc"
#  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libopencv_reg.so.3.2.0"
#  IMPORTED_SONAME_RELEASE "libopencv_reg.so.3.2"
#  )

#list(APPEND _IMPORT_CHECK_TARGETS opencv_reg )
#list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_reg "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libopencv_reg.so.3.3.1" )
...
#  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libopencv_surface_matching.so.3.2.0"
#  IMPORTED_SONAME_RELEASE "libopencv_surface_matching.so.3.2"
#  )

#list(APPEND _IMPORT_CHECK_TARGETS opencv_surface_matching )
#list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_surface_matching "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libopencv_surface_matching.so.3.2.0" )

# Import target "opencv_video" for configuration "Release"
set_property(TARGET opencv_video APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
set_target_properties(opencv_video PROPERTIES
  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE "opencv_core;opencv_imgproc"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libopencv_video.so.3.3.1"
  IMPORTED_SONAME_RELEASE "libopencv_video.so.3.3"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_video )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_video "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libopencv_video.so.3.3.1" )
...
#  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE "opencv_core"
#  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libopencv_viz.so.3.2.0"
#  IMPORTED_SONAME_RELEASE "libopencv_viz.so.3.2"
#  )

#list(APPEND _IMPORT_CHECK_TARGETS opencv_viz )
#list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_viz "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libopencv_viz.so.3.2.0" )
...
#  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE "opencv_core;opencv_imgproc"
#  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libopencv_freetype.so.3.2.0"
#  IMPORTED_SONAME_RELEASE "libopencv_freetype.so.3.2"
#  )

#list(APPEND _IMPORT_CHECK_TARGETS opencv_freetype )
#list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_freetype "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libopencv_freetype.so.3.2.0" )
...
#  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE "opencv_core;opencv_imgproc"
#  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libopencv_fuzzy.so.3.2.0"
#  IMPORTED_SONAME_RELEASE "libopencv_fuzzy.so.3.2"
#  )

#list(APPEND _IMPORT_CHECK_TARGETS opencv_fuzzy )
#list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_fuzzy "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libopencv_fuzzy.so.3.2.0" )
...
set_target_properties(opencv_imgcodecs PROPERTIES
  ...
  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE ""
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libopencv_imgcodecs.so.3.3.1"
  IMPORTED_SONAME_RELEASE "libopencv_imgcodecs.so.3.3"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_imgcodecs )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_imgcodecs "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libopencv_imgcodecs.so.3.3.1" )
...
set_target_properties(opencv_shape PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libopencv_shape.so.3.3.1"
  IMPORTED_SONAME_RELEASE "libopencv_shape.so.3.3"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_shape )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_shape "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libopencv_shape.so.3.3.1" )
...
set_target_properties(opencv_videoio PROPERTIES
  ...
  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE ""
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libopencv_videoio.so.3.3.1"
  IMPORTED_SONAME_RELEASE "libopencv_videoio.so.3.3"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_videoio )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_videoio "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libopencv_videoio.so.3.3.1" )
...
set_target_properties(opencv_highgui PROPERTIES
  ...
  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE ""
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libopencv_highgui.so.3.3.1"
  IMPORTED_SONAME_RELEASE "libopencv_highgui.so.3.3"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_highgui )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_highgui "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libopencv_highgui.so.3.3.1" )
...
set_target_properties(opencv_objdetect PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libopencv_objdetect.so.3.3.1"
  IMPORTED_SONAME_RELEASE "libopencv_objdetect.so.3.3"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_objdetect )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_objdetect "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libopencv_objdetect.so.3.3.1" )
...
#  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libopencv_plot.so.3.2.0"
#  IMPORTED_SONAME_RELEASE "libopencv_plot.so.3.2"
#  )

#list(APPEND _IMPORT_CHECK_TARGETS opencv_plot )
#list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_plot "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libopencv_plot.so.3.3.1" )
...
set_target_properties(opencv_superres PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libopencv_superres.so.3.3.1"
  IMPORTED_SONAME_RELEASE "libopencv_superres.so.3.3"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_superres )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_superres "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libopencv_superres.so.3.3.1" )
...
#  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libopencv_xobjdetect.so.3.2.0"
#  IMPORTED_SONAME_RELEASE "libopencv_xobjdetect.so.3.2"
#  )

#list(APPEND _IMPORT_CHECK_TARGETS opencv_xobjdetect )
#list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_xobjdetect "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libopencv_xobjdetect.so.3.3.1" )
...
#  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libopencv_xphoto.so.3.2.0"
#  IMPORTED_SONAME_RELEASE "libopencv_xphoto.so.3.2"
#  )

#list(APPEND _IMPORT_CHECK_TARGETS opencv_xphoto )
#list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_xphoto "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libopencv_xphoto.so.3.3.1" )
...
#  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libopencv_bgsegm.so.3.2.0"
#  IMPORTED_SONAME_RELEASE "libopencv_bgsegm.so.3.2"
#  )

#list(APPEND _IMPORT_CHECK_TARGETS opencv_bgsegm )
#list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_bgsegm "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libopencv_bgsegm.so.3.3.1" )
...
#  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE "opencv_core;opencv_imgproc;opencv_imgcodecs;opencv_videoio;opencv_highgui"
#  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libopencv_bioinspired.so.3.2.0"
#  IMPORTED_SONAME_RELEASE "libopencv_bioinspired.so.3.2"
#  )

#list(APPEND _IMPORT_CHECK_TARGETS opencv_bioinspired )
#list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_bioinspired "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libopencv_bioinspired.so.3.3.1" )
...
#  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE "opencv_core;opencv_imgproc;opencv_ml;opencv_imgcodecs;opencv_videoio;opencv_highgui;opencv_objdetect"
#  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libopencv_dpm.so.3.2.0"
#  IMPORTED_SONAME_RELEASE "libopencv_dpm.so.3.2"
#  )

#list(APPEND _IMPORT_CHECK_TARGETS opencv_dpm )
#list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_dpm "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libopencv_dpm.so.3.3.1" )
...
#  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE "opencv_core;opencv_imgproc;opencv_ml;opencv_imgcodecs;opencv_videoio;opencv_highgui;opencv_objdetect"
#  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libopencv_face.so.3.2.0"
#  IMPORTED_SONAME_RELEASE "libopencv_face.so.3.2"
#  )

#list(APPEND _IMPORT_CHECK_TARGETS opencv_face )
#list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_face "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libopencv_face.so.3.3.1" )
...
set_target_properties(opencv_features2d PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libopencv_features2d.so.3.3.1"
  IMPORTED_SONAME_RELEASE "libopencv_features2d.so.3.3"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_features2d )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_features2d "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libopencv_features2d.so.3.3.1" )
...
#  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libopencv_line_descriptor.so.3.2.0"
#  IMPORTED_SONAME_RELEASE "libopencv_line_descriptor.so.3.2"
#  )

#list(APPEND _IMPORT_CHECK_TARGETS opencv_line_descriptor )
#list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_line_descriptor "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libopencv_line_descriptor.so.3.3.1" )
...
#  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE "opencv_core;opencv_flann;opencv_imgproc;opencv_ml;opencv_imgcodecs;opencv_videoio;opencv_highgui;opencv_features2d"
#  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libopencv_saliency.so.3.2.0"
#  IMPORTED_SONAME_RELEASE "libopencv_saliency.so.3.2"
#  )

#list(APPEND _IMPORT_CHECK_TARGETS opencv_saliency )
#list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_saliency "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libopencv_saliency.so.3.3.1" )
...
#  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE "opencv_core;opencv_flann;opencv_imgproc;opencv_ml;opencv_imgcodecs;opencv_videoio;opencv_highgui;opencv_features2d"
#  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libopencv_text.so.3.2.0"
#  IMPORTED_SONAME_RELEASE "libopencv_text.so.3.2"
#  )

#list(APPEND _IMPORT_CHECK_TARGETS opencv_text )
#list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_text "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libopencv_text.so.3.3.1" )

# Import target "opencv_calib3d" for configuration "Release"
set_property(TARGET opencv_calib3d APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
set_target_properties(opencv_calib3d PROPERTIES
  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE "opencv_core;opencv_flann;opencv_imgproc;opencv_ml;opencv_imgcodecs;opencv_videoio;opencv_highgui;opencv_features2d"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libopencv_calib3d.so.3.3.1"
  IMPORTED_SONAME_RELEASE "libopencv_calib3d.so.3.3"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_calib3d )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_calib3d "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libopencv_calib3d.so.3.3.1" )
...
#  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libopencv_ccalib.so.3.2.0"
#  IMPORTED_SONAME_RELEASE "libopencv_ccalib.so.3.2"
#  )

#list(APPEND _IMPORT_CHECK_TARGETS opencv_ccalib )
#list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_ccalib "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libopencv_ccalib.so.3.3.1" )
...
#  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libopencv_datasets.so.3.2.0"
#  IMPORTED_SONAME_RELEASE "libopencv_datasets.so.3.2"
#  )

#list(APPEND _IMPORT_CHECK_TARGETS opencv_datasets )
#list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_datasets "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libopencv_datasets.so.3.3.1" )
...
#  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE "opencv_core;opencv_flann;opencv_imgproc;opencv_ml;opencv_imgcodecs;opencv_videoio;opencv_highgui;opencv_features2d;opencv_calib3d"
#  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libopencv_rgbd.so.3.2.0"
#  IMPORTED_SONAME_RELEASE "libopencv_rgbd.so.3.2"
#  )

#list(APPEND _IMPORT_CHECK_TARGETS opencv_rgbd )
#list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_rgbd "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libopencv_rgbd.so.3.3.1" )
...
#  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE "opencv_core;opencv_flann;opencv_imgproc;opencv_ml;opencv_imgcodecs;opencv_videoio;opencv_highgui;opencv_features2d;opencv_calib3d"
#  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libopencv_stereo.so.3.2.0"
#  IMPORTED_SONAME_RELEASE "libopencv_stereo.so.3.2"
#  )

#list(APPEND _IMPORT_CHECK_TARGETS opencv_stereo )
#list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_stereo "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libopencv_stereo.so.3.3.1" )
...
set_target_properties(opencv_stitching PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libopencv_stitching.so.3.3.1"
  IMPORTED_SONAME_RELEASE "libopencv_stitching.so.3.3"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_stitching )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_stitching "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libopencv_stitching.so.3.3.1" )
...
set_target_properties(opencv_videostab PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libopencv_videostab.so.3.3.1"
  IMPORTED_SONAME_RELEASE "libopencv_videostab.so.3.3"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_videostab )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_videostab "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libopencv_videostab.so.3.3.1" )
...
#  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE "opencv_core;opencv_flann;opencv_imgproc;opencv_ml;opencv_imgcodecs;opencv_videoio;opencv_highgui;opencv_features2d;opencv_calib3d"
#  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libopencv_ximgproc.so.3.2.0"
#  IMPORTED_SONAME_RELEASE "libopencv_ximgproc.so.3.2"
#  )

#list(APPEND _IMPORT_CHECK_TARGETS opencv_ximgproc )
#list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_ximgproc "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libopencv_ximgproc.so.3.3.1" )
...
#  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE "opencv_core;opencv_flann;opencv_imgproc;opencv_ml;opencv_imgcodecs;opencv_videoio;opencv_highgui;opencv_features2d;opencv_calib3d"
#  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libopencv_aruco.so.3.2.0"
#  IMPORTED_SONAME_RELEASE "libopencv_aruco.so.3.2"
#  )

#list(APPEND _IMPORT_CHECK_TARGETS opencv_aruco )
#list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_aruco "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libopencv_aruco.so.3.3.1" )
...
#  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libopencv_optflow.so.3.2.0"
#  IMPORTED_SONAME_RELEASE "libopencv_optflow.so.3.2"
#  )

#list(APPEND _IMPORT_CHECK_TARGETS opencv_optflow )
#list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_optflow "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libopencv_optflow.so.3.3.1" )
...
#  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libopencv_phase_unwrapping.so.3.2.0"
#  IMPORTED_SONAME_RELEASE "libopencv_phase_unwrapping.so.3.2"
#  )

#list(APPEND _IMPORT_CHECK_TARGETS opencv_phase_unwrapping )
#list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_phase_unwrapping "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libopencv_phase_unwrapping.so.3.3.1" )
...
#  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libopencv_structured_light.so.3.2.0"
#  IMPORTED_SONAME_RELEASE "libopencv_structured_light.so.3.2"
#  )

#list(APPEND _IMPORT_CHECK_TARGETS opencv_structured_light )
#list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_structured_light "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libopencv_structured_light.so.3.3.1" )
